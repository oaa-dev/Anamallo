            ...
            <div class="page-footer pull-right">
                <div class="page-footer-inner"><?php echo date("l, F d, Y");?></a>
                </div>
        ...
        <script src="<?php echo base_url();?>assets/global/plugins/jquery-repeater/jquery.repeater.js" type="text/javascript">
        </script>
