...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
    <!-- BEGIN PAGE HEADER-->
    <h1 class="page-title"> Invoice Report
        ...
        <div class="portlet light bordered">
          <div class="portlet-title">
            <div class="caption font-dark">
              ...
              <span class="caption-subject bold uppercase">Invoice Information</span>
            </div>
            <div class="col-md-5">
              <div class="btn-group">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="manageTable" role="grid" aria-describedby="sample_1_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" style="width: 80px;"> Official Receipt </th>
                      <th class="sorting" style="width: 100px;"> Customer Name </th>
                      <th class="sorting" style="width: 100px;"> Discount Amount </th>
                      <th class="sorting" style="width: 100px;"> Total Amount </th>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#range_search').on('click', function () {
      ...
      manageTable = $('#manageTable').DataTable({
        'order': [],
        'ajax': {
          url:'<?php echo base_url();?>invoice/find_invoice/'+from+'/'+to
        },
        "dom": 'Bfrtip',
        "buttons":
        [
  ...
  function details(id){
    manageDetails=$('#manageDetails').DataTable({
      'order': [],
      'ajax': {
        url:'<?php echo base_url();?>invoice/find_invoice_details/'+id
      }
    });
  ...
  function view(){
    manageTable = $('#manageTable').DataTable({
      'order': [],
      'ajax': {
        url:'<?php echo base_url();?>invoice/find_invoice'
      },
      "dom": 'Bfrtip',
      "buttons":
      [
